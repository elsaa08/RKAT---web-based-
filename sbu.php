                ...
                <div class="table-responsive mt-3">
                    <?php
                            ...
                            echo "<table class='table table-responsive table-hover table-striped'>
                                    <thead>
                                        <tr>
                                            <th scope='col' class='text-primary'>Kode SBU</th>
                                            <th scope='col' class='text-primary'>Uraian</th>
                                            <th scope='col' class='text-primary'>Tarif</th>
                                            <th scope='col' class='text-primary'>Kode MAK</th>
                                        </tr>
                                    </thead>
                                    <tbody>";
                            ...
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                echo "<tr>";
                                echo "<td> {$row['kode_sbu']} </td>";
                                echo "<td> {$row['uraian']} </td>";
                                echo "<td> {$row['tarif']} </td>";
                                echo "<td> {$row['kode_mak']} </td>";
                                echo "</tr>";
                                $i++;
                                }
                                echo "</tbody>";
                    ...
                    <!-- <a href="add_mak.php" class="text-decoration-none text-primary">
                        <button type="submit" class="btn btn-primary text-center" name="add" id="add">Add SBU</button>
                    </a> -->
                </div>
                <div class="line"></div>
            </div>
